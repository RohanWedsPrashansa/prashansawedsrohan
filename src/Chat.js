...
class Chats extends Component {
    ...
    scheduleNextUpdate =() => {
        ...
        this.timer = setTimeout(()=>{
            ...
            //     clearTimeout(this.timer)
            // }
            else if(this.state.itemsRendered===22 && !this.state.showButton){
                this.setState({
                    showButton:true
                })
                this.scrollToBot();
        ...
        return (
            ...
            {/* <div className='overlay'>  </div> */}
                        ...
                        >
                            ...
                            {   
                            this.state.itemsRendered===22 && this.state.showButton && this.button1()
                            }
                            {   
                            this.state.itemsRendered===26 && this.state.showButton && this.button1()
                            }
                            {/* {
                            this.state.itemsRendered===36 &&  this.state.showButton && this.button1()
                            } */}
